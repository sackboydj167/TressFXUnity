...
namespace TressFX
{
    ...
    public class TressFXSimulation : MonoBehaviour
    {
        ...
        /// <summary>
        /// Use the scene's windzone.
        /// </summary>
        public bool useSceneWindzone = false;
        ...
        /// <summary>
        /// The WindZone in the scene.
        /// </summary>
        private WindZone sceneWindZone = null;
        ...
        public void Awake()
        {
            if (useSceneWindzone)
            {
                ...
                {
                    Debug.LogError("TressFXSimulation is set to use the scene's WindZone, but it doesn't exist! :-'(");
                    this.enabled = false;
                    return;
                }
                if (sceneWindZone.mode == WindZoneMode.Spherical)
                {
                    Debug.LogError("The WindZone in the scene is set to Spherical! This is not supported yet :-'(");
                    this.enabled = false;
                    return;
                }
                windDirection = sceneWindZone.transform.forward;
                windMagnitude = sceneWindZone.windMain + sceneWindZone.windTurbulence;
            }
            // No shader? :-(
